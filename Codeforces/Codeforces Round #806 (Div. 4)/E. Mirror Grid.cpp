...
void its_Function() {
 ...
 //    cout<<i<<endl;
 vector<char> ans;
        ll r1 = 0, r2 = vect.size()-1, c1 = 0, c2 = vect[0].size()-1;
        ll val = 1;
        while(r1<=r2 and c1<=c2)
        {
            for(ll c = c1; c<=c2; c++)
                ans.push_back(vect[r1][c]);
            for(ll r = r1+1; r<=r2;r++)
                ans.push_back(vect[r][c2]);
            
            if(r1<r2 and c1<c2)
            {
            for(ll c = c2-1; c>c1; c--)
                ans.push_back(vect[r2][c]);
            for(ll r = r2; r>r1;r--)
                ans.push_back(vect[r][c1]);
            }
            r1++;
            r2--;
            c1++;
