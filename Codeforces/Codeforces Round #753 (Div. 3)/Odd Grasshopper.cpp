...
void its_Function() {
   ll x0, n;
   cin>>x0>>n;
   ll a1 = -1, a2=2,a3=3,a4=-4,d1=-4,d2=4,d3=4,d4=-4;
   double tempN = n;
   ll n1 = ceil(tempN/4), n2, n4,n3;
   ll val = a1 + d1*(n1-1);
//   cout<<val<<endl;
   if(abs(val)+1<=n)
   {
...
//   cout<<n1<<" "<<n2<<" "<<n3<<" "<<n4<<endl;
   ...
   ll sum1 = (n1*(2*a1 + (n1-1)*d1))/2;
   ll sum2 = (n2*(2*a2 + (n2-1)*d2))/2;
   ll sum3 = (n3*(2*a3 + (n3-1)*d3))/2;
   ll sum4 = (n4*(2*a4 + (n4-1)*d4))/2;
    cout<<(x0 + sum1 + sum2 + sum3 + sum4);
}
