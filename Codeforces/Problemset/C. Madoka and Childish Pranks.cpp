// Problem Link - https://codeforces.com/contest/1647/problem/C
...
/* for(auto i:op)
 ...
 for(auto i:ans)
 {
    cout<<i.ui+1<<" "<<i.uj+1<<" "<<i.li+1<<" "<<i.lj+1<<endl;
 }
}
