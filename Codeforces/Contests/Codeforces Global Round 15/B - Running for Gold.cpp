...
{
    vector<ll>vect;
    vect.push_back(arr[i][0] - arr[mini][0]);
    vect.push_back(arr[i][1] - arr[mini][1]);
    vect.push_back(arr[i][2] - arr[mini][2]);
    vect.push_back(arr[i][3] - arr[mini][3]);
    vect.push_back(arr[i][4] - arr[mini][4]);
    sort(full(vect));
...
ll count = 0;
    for(ll i=0;i<n;i++)
    {
        ...
        vect.push_back(arr[i][4] - arr[mini][4]);
        sort(full(vect));
        if(vect[2]>0 and vect[3]>0 and vect[4]>0)
        {
            count++;
        }
    }
