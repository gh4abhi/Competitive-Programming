...
int main()
{
    ...
    for(ll i=0;i<m;i++)
    {
        ll x,y;
        cin>>x>>y;
        ll AttackX = lower_bound(full(vect),x) - vect.begin();
        ll coins=0;
        if(AttackX<n)
        {
            ll defense = sum-vect[AttackX];
            ...
            else
            {
                ...
                {
                    ll AttackBack = AttackX-1;
                    ll newDefense = sum-vect[AttackBack];
                    if(newDefense<y)
                    {
                        ll coins1 = x-vect[AttackBack] + y-(sum-vect[AttackBack]);
                        ll coins2 = y - defense;
                        cout<<min(coins1,coins2);
                    }
                    else
                    {
                        ll coins1 = x-vect[AttackBack];
                        ll coins2 = y - defense;
                        cout<<min(coins1,coins2);
                    }
        ...
        {
            ll sAttack = vect[n-1];
            ll defense = sum - sAttack;
            if(defense>=y)
            cout<<(x-sAttack);
            else
                cout<<(x-sAttack) + (y-defense);
        }
        cout<<endl;
    }
